  ...
  return h(
    ...
    [
                            ...
                            h("img", {
                              style: {
                                ...
                                transform: [
                                  ...
                                  ...(this.rotated
                                    ? [
                                        `translateX(${this.internalImageHeight}px)`,
                                        "rotate(90deg)"
                                      ]
                                    : []),
                                  ...(this.flippedVertically
                                    ? [
                                        `translateY(${this.internalImageHeight}px)`,
                                        "scaleY(-1)"
                                      ]
                                    : []),
                                  ...(this.flippedHorizontally
                                    ? [
                                        `translateX(${this.internalImageWidth}px)`,
                                        "scaleX(-1)"
                                      ]
                                    : [])
                                ].join(" "),
      ...
      h(
        ...
        [
          ...(this.clearable ? [h("MyClearButton"), h("VSpacer")] : []),
      ...
      h(
        ...
        this.hideActions || this.readonly ? [] : [h("MyScalingSlider")]
      )
    ]
  );
}
